...
part of 'BackgroundNode.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

BackgroundNode<T> _$BackgroundNodeFromJson<T extends BaseNode>(
        Map<String, dynamic> json) =>
    BackgroundNode<T>(
      assetPath: BaseNodeConverter<T>().fromJson(json['assetPath']),
    )..type = $enumDecode(_$ENodeTypeEnumMap, json['type']);

Map<String, dynamic> _$BackgroundNodeToJson<T extends BaseNode>(
        BackgroundNode<T> instance) =>
    <String, dynamic>{
