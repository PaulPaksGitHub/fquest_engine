...
part of 'InitSceneAction.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

InitSceneAction _$InitSceneActionFromJson(Map<String, dynamic> json) =>
    InitSceneAction(
      label: json['label'] as String,
      type: $enumDecode(_$GSActionTypeEnumMap, json['type']),
    );

Map<String, dynamic> _$InitSceneActionToJson(InitSceneAction instance) =>
    <String, dynamic>{
